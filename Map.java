...
abstract interface Map<K,V> {
    ...
    Iterable<K> keySet(); //Devuelve la coleccion de llaves del mapa
    
    Iterable<V> values(); //Devuelve la colección de valores del mapa 
    
    Iterable<Entry<K,V>> entrySet(); //Devuelve todos los elementos del mapa   
